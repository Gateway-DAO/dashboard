...
import GatewayLogo from '@/app/(landing)/old/components/gateway-logo';
import Link from '@/app/(landing)/old/components/Link';
import Button from '@/app/(landing)/old/components/button';
import Fingerprint from '@/app/(landing)/old/components/svgs/fingerprint';
import { joinClasses } from '@/app/(landing)/old/utils/function';

import styles from './for-business.module.scss';
import UserPrivacy from '@/app/(landing)/old/components/icons/user-privacy';
import DataVerifiability from '@/app/(landing)/old/components/icons/data-verifiability';
import Scalable from '@/app/(landing)/old/components/icons/scalable';
import Portable from '@/app/(landing)/old/components/icons/portable';
    ...
    <section className={styles.element} ref={sectionRef}>
      <Wrapper>
        ...
        <div className={styles.highlight}>
          <GatewayLogo
            className={joinClasses(styles.item_icon, styles['logo'])}
            variant="light"
          />
          ...
          <p
            className={joinClasses(
              styles.item_text,
              styles['item_text--white']
            )}
          >
            Gateway enables teams to give their users control over personal{' '}
            <br />
          ...
          <div className={styles.buttons}>
            <a
              ...
              href="https://mygateway.xyz/login"
              target="_blank"
            >
              <Button
                className={joinClasses(
