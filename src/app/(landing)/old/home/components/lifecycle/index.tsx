...
import Fingerprint from '@/app/(landing)/old/components/icons/fingerprint';
import Issue from '@/app/(landing)/old/components/icons/issue';
import Manage from '@/app/(landing)/old/components/icons/manage';
import Own from '@/app/(landing)/old/components/icons/own';
import Replay from '@/app/(landing)/old/components/icons/replay';
import Verify from '@/app/(landing)/old/components/icons/verify';
import Modal from '@/app/(landing)/old/components/modal';
import Portal from '@/app/(landing)/old/components/portal';
import { default as LifecycleVector } from '@/app/(landing)/old/components/svgs/lifecycle';
