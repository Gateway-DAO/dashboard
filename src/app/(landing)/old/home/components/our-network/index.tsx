...
import ForIssues from '@/app/(landing)/old/components/svgs/for-issues';
import ForOwners from '@/app/(landing)/old/components/svgs/for-owners';
import ForVerifies from '@/app/(landing)/old/components/svgs/for-verifies';
