import ContributeData from '@/app/(landing)/old/components/svgs/contribute-data';
import Button from '@/app/(landing)/old/components/button';
import RequestData from '@/app/(landing)/old/components/svgs/request-data';
import styles from './for-developers.module.scss';
import { joinClasses } from '@/app/(landing)/utils/function';
@/app/(landing)/old/utils/function
const data = [
  {
    icon: ContributeData,
    title: 'Contribute Data',
    description:
      'Begin contributing data and empowering users to claim their data directly from your application.',
    buttons: [
      <a
        className={styles.button_link}
        href="https://docs.mygateway.xyz/sdk/introduction"
        key={0}
        target="_blank"
      >
        <Button
          className={joinClasses(styles.button, styles['button--outlined'])}
          variant="outlined"
        >
          Integrate SDK
        </Button>
      ...
      <a
        className={styles.button_link}
        href="https://mygateway.xyz/dashboard/user/assets/issue"
        key={1}
        target="_blank"
      >
...
console.log(createPDA);`,
  },
  {
    ...
    title: 'Request Data',
    description:
      'Begin issuing your first Private Data Assets to your users and unlock a world of possibilities.',
    buttons: [
      <a
        className={styles.button_link}
        href="https://docs.mygateway.xyz/sdk/introduction"
