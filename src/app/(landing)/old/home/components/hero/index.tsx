    ...
    <section className={styles.element} ref={sectionRef}>
      <Wrapper className={styles.wrapper}>
        <h1 className={styles.title}>
          Transform your <br />
          <span className={styles.highlight}>Data</span> into{' '}
          <span className={styles.highlight}>Assets</span>
        </h1>
        <p className={styles.text}>
          Gateway is the first decentralized identity access management
          protocol, <br />
        ...
        <p className={joinClasses(styles.text, styles['text--dark'])}>
          Trusted by
        </p>
        ...
        <div className={styles.logos}>
          <div
            className={joinClasses(
              styles.logos_container,
              styles['logos_container--desktop']
            )}
          >
            <Marquee>
