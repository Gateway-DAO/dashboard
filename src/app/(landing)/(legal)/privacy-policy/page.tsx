    ...
    <>
      ...
      <InternalContent>
        ...
        <p>
          ...
          websites or services that state that they are offered under a
          different privacy policy. Please review the privacy policies on those
          websites directly to understand their privacy practices.
        </p>
        <p>
          <strong>Personal Information We Collect</strong>
        </p>
        <p>
          Depending on the nature of your interaction with Gateway, we may
        ...
        <ul>
          ...
          <li>
            From third parties at your direction. Our Services enable you to
            take control of your private data assets in one place. You may
          ...
          <li>
            From publicly available blockchain sources, including timestamps of
        ...
        <p>
          When you interact with the Services, certain information about your
          use of our Services is automatically collected. This includes:
        </p>
        ...
        <p>
          Much of this information is collected through cookies, web beacons,
          and other tracking technologies, which may be operated by our partners
          who assist us in conducting analytics, security, and fraud prevention.
          For example, we use Google Analytics to conduct analytics. You can
          learn more about privacy and Google Analytics by visiting{' '}
          <a href="https://support.google.com/analytics/answer/6004245">
            https://support.google.com/analytics/answer/6004245
          </a>
          . You can opt out of collection of your data by using the Google
        ...
        <p>
          We may use and share information in an aggregated or de-identified
          manner data at our discretion, including for research, analysis,
          modeling, marketing, and improvement of our Services.
        </p>
        ...
        <p>
          Please note that your private data assets may be stored, based on your
          selection and instruction, by the We share personal information in the
          following instances:
        </p>

        <ul>
          <li>
            At your instruction, and if you have elected to provide us with the
            necessary access key(s), we will provide access to your private data
            assets to the recipient(s) you select using the Services, and the
            Services will also register the event with the decentralized
            blockchain solution that hosts such event data for purpose of the
            Services. If you select ongoing sharing and wish to discontinue
            sharing your private data assets with the recipient(s) you have
            selected, you may do so using the Services. Please note this Privacy
          ...
          <li>
            ...
            similar technologies on our Services to assist us with measuring
            visits and traffic on our Services so we can measure and improve the
          ...
          <li>
            ...
            to another entity or its affiliates or service providers some or all
            ...
            same privacy practices or treat your information the same as
            described in this Privacy Policy, except to the extent it is
            required to do so by applicable law.
          </li>
          <li>
            To comply with law, to respond to requests from law enforcement
            agencies or other government authorities or third parties, as
            permitted by law and without your consent when it is necessary to
            protect our customers, employees, or property, in emergency
            situations, or to enforce our rights.
          </li>
        </ul>
        ...
        <p>
          <strong>Your Privacy Options</strong>
        </p>

        <p>
          You may have certain choices when it comes to how we collect and use
        ...
        <p>
          We do not knowingly or intentionally gather information from or about
        ...
        <p>
          We may make changes to this Privacy Policy from time to time. The
          “Effective Date” at the top of this page indicates when this Privacy
          Policy was last revised. We may also notify you in other ways from
          time to time about the collection, use, and disclosure of your
