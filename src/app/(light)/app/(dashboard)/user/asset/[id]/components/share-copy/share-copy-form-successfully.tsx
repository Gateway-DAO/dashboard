...
import ProofCardInfo from '@/app/(light)/app/(dashboard)/user/proof/[id]/components/proof-card-info';
import ProofCardTitle from '@/app/(light)/app/(dashboard)/user/proof/[id]/components/proof-card-title';
